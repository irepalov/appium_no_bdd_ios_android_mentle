...
public class YourWellBeing extends IOSBase {
    ...
    @Step("check Your Well Being Title is displayed")
    public void checkYourWellBeingTitleIsDisplayed() {
        logger.info("check Your Well Being Title is displayed");
        verifyElementIsPresent(yourWellBeingTitle);
    }

    @Step("check Your Well Being Title is displayed correctly")
    public void checkYourWellBeingTitleIsDisplayedCorrectly(String expectedTitle) {
